...
const Footer = () => {
  return (
    <footer className="bg-linear-to-b from-slate-50 to-blue-200 pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 relative">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-3 mb-3 text-gray-700">
              ...
              <span>info@tuitionterminal.com.bd</span>
            </div>

            <div className="flex items-center gap-3 mb-3 text-gray-700">
              <FaPhone className="text-green-500 text-xl" />
              <span>Call Hotline : 09678-444477</span>
            </div>

            <div className="flex items-center gap-3 mb-6 text-gray-700">
              <FaMapMarkerAlt className="text-green-500 text-xl" />
              <span>
                House-10/5, Tolarbagh R/A, Section-#1, Mirpur, Dhaka
              </span>
            </div>
      ...
      <div className="mt-10 text-center text-gray-500 text-sm">
        © {new Date().getFullYear()} Tuition Terminal. All Rights Reserved.
      </div>
    </footer>
  );
};
